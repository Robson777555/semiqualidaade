<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $sql = "SELECT * FROM calca WHERE id = '$id'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if (isset($_POST['submit'])) {
                ...
                $sql = "UPDATE calca SET marca = '$marca', emEstoque = '$emEstoque', emEncomenda = '$emEncomenda',
                        emReserva = '$emReserva'
                        WHERE id = '$id'";
                $result = mysqli_query($conn, $sql);
                ...
                if ($result) {
                    ...
                    echo 'Erro ao atualizar calça: ' . mysqli_error($conn);
                }
            }

            // Exibir o formulário de edição
            echo '<h2>Editar Calça</h2>';
